...
const ChatBot = () => {
  ...
  return (
    <motion.div
      className={`fixed bottom-5 right-5 z-40 ${isMinimized ? 'w-auto' : 'w-full sm:w-[400px]'}`}
        ...
        <Card className="border border-primary/20 shadow-xl overflow-hidden">
          ...
          <div className="bg-primary text-primary-foreground p-3 flex justify-between items-center">
            ...
            <div className="flex items-center gap-1">
              <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-primary-foreground hover:text-white hover:bg-primary/80" onClick={() => setIsMinimized(true)}>
